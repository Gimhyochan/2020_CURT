...
//*********************************************************************************************************************************
// o SEED_Sbox1[]		: SEED_G() �Լ����� ����ϴ� ���Ǵ� ��ġ ���̺��μ� 8��Ʈ�� �Է¹޾� 8��Ʈ�� �����
//*********************************************************************************************************************************
...
//*********************************************************************************************************************************
// o SEED_Sbox2[]		: SEED_G() �Լ����� ����ϴ� ���Ǵ� ��ġ ���̺��μ� 8��Ʈ�� �Է¹޾� 8��Ʈ�� �����
//*********************************************************************************************************************************
...
#define SEED_Masking_KeySched(L0, L1, R0, R1, K) {             \
    ...
    T1 = MSS0[GetB0(T1)] ^ MSS1[GetB1(T1)] ^         \
         MSS2[GetB2(T1)] ^ MSS3[GetB3(T1)] ^ m0_4;          \
    T0 = (T0 + T1) & 0xffffffff;                   \
    T0 = MSS0[GetB0(T0)] ^ MSS1[GetB1(T0)] ^         \
         MSS2[GetB2(T0)] ^ MSS3[GetB3(T0)] ^ m0_4;          \
    T1 = (T1 + T0) & 0xffffffff;                   \
    T1 = MSS0[GetB0(T1)] ^ MSS1[GetB1(T1)] ^         \
         MSS2[GetB2(T1)] ^ MSS3[GetB3(T1)] ^ m0_4;          \
    T0 = (T0 + T1) & 0xffffffff;                   \
